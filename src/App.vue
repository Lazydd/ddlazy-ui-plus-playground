...
<template>
    <Header :store="store" :prod="productionMode" @toggle-theme="toggleTheme" @toggle-prod="toggleProdMode"
        @reload-page="reloadPage" />
    <Repl ref="replRef" :theme="theme" :editor="Monaco" @keydown.ctrl.s.prevent @keydown.meta.s.prevent :store="store"
        :showCompileOutput="true" :autoResize="true" :clearConsole="false" :preview-options="{
        customCode: {
